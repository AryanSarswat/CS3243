...
class Board:
    def __init__(self, rows, columns, costs, obstacles_locations, enemy_pieces, friendly_pieces, goal_positions):
        ...
        for loc in obstacles_locations:
            ...
            self.costs[loc[0]][loc[1]] = "\033[1;33;40mX\033[0m"
        ...
        for piece in enemy_pieces:
            ...
            for pos in attacked_positions:
                ...
                self.costs[pos[0]][pos[1]] = "\033[1;31;40mA\033[0m"
...
def search(board, piece):
    ...
    frontier.push((0, [piece.current_position]))
    nodesExplored = set()
    numNodesExplored = 0
    while len(frontier.queue) > 0:
        ...
        if board.isGoal(current_position):
            return current_path[1], numNodesExplored, current_path[0]
        ...
        for move in pos_moves:
            moves_costs.append((board.costToMove(move) + current_path[0], move))

            
        for moves in moves_costs:
            coord = moves[1]
            cost = moves[0]
